...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-zlc-blue-900 via-zlc-blue-800 to-zlc-blue-700 mt-16">
        <div
          className={
      ...
      <section className="py-20 bg-zlc-gray-50">
        <div className="container-section">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-zlc-gray-600 max-w-2xl mx-auto">
              Aprovechamos los beneficios únicos de la Zona Libre de Colón para
              ofrecerle precios competitivos y procesos simplificados.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container-section">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-zlc-gray-600 max-w-2xl mx-auto">
              En solo 4 pasos puede estar comprando productos al por mayor desde
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <div className="font-bold text-lg">ZLC Express</div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center text-zlc-gray-400">
                  ...
                  <span>Zona Libre de Colón, Panamá</span>
                </div>
                <div className="flex items-center text-zlc-gray-400">
                  <Phone className="mr-2 h-4 w-4" />
                  <span>+507 430-1234</span>
                </div>
                <div className="flex items-center text-zlc-gray-400">
                  <Mail className="mr-2 h-4 w-4" />
                  <span>contacto@zlcexpress.com</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-zlc-gray-400">
                <li>
                  <Link to="/categories/textiles" className="hover:text-white">
                    Textiles y Confección
                  </Link>
                </li>
                <li>
                  <Link to="/categories/footwear" className="hover:text-white">
                    Calzado
                  </Link>
                </li>
                <li>
