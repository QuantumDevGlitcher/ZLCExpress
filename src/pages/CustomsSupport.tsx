    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-gray-600 max-w-4xl mx-auto">
          Centro de apoyo especializado para trámites aduaneros y documentación
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4">
              ...
              <p className="text-gray-600 text-sm">
                Mercancías en tránsito libres de aranceles y impuestos durante
                su estadía en ZLC
              </p>
            </div>
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold text-lg mb-2">Plazos Flexibles</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center p-4">
              ...
              <p className="text-gray-600 text-sm">
                Posición estratégica para distribución hacia toda América Latina
                y el Caribe
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700">
                  ...
                  este período, se requiere extensión especial o nacionalización
                  inmediata para evitar multas y recargos.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-4">
                Especialista en comercio internacional con amplia experiencia en
                trámites aduaneros de la Zona Libre de Colón. Iris te ayudará a
                navegar los procesos de importación/exportación, garantizando el
                cumplimiento de todas las regulaciones y optimizando los tiempos
                de despacho.
              </p>
            ...
            <div className="lg:w-2/3">
              {selectedStep && (
                <div className="space-y-6">
                  {(() => {
                    const step = importSteps.find((s) => s.id === selectedStep);
                    if (!step) return null;
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-blue-700">
                                  Este paso incluye una revisión personalizada
                                  con nuestra asesora aduanera. Iris verificará
                                  todos los documentos y te guiará en los
                                  próximos pasos.
                                </p>
                              </div>
                            </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setConsultation((prev) => ({
                      ...prev,
                      urgency: e.target.value as IrisConsultation["urgency"],
                    }))
                  }
            ...
            <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-green-700">
                  ...
                  responderá tu consulta según la urgencia seleccionada. Todas
                  las consultas incluyen seguimiento personalizado.
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Sáb: 8:00 AM - 2:00 PM</p>
